  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Render text, sticker, viewOnce or standard file content */}
          {message.type === 'text' ? (
      ...
      {/* View-Once Full Screen Modal Overlay */}
      {modalOpen && (
        <div style={{
          position: 'fixed',
          top: 0,
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <span style={{ fontSize: '0.9rem', fontWeight: 600 }}>Foto de un solo uso</span>
            </div>
            <div style={{
